...
@Component({
  selector: 'my-video-mirror-url',
  templateUrl: './video-mirror-url.component.html',
  styleUrls: [
    '../shared/video-edit.component.scss',
    './video-send.scss'
  ]
})
export class VideoMirrorUrlComponent extends VideoSend implements OnInit, AfterViewInit, CanComponentDeactivate {
